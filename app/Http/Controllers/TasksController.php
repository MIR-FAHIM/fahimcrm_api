...
$department = Department::find($id);
    ...
    public function showTaskDetails($taskId)
    {
        try {
            // Find the task by ID
            $task = Tasks::where('id',$taskId)->with('taskType', 'project', 'priority', 'creator', 'status', 'assignedPersons', 'taskVisitRelation.visit.zone', 'taskVisitRelation.visit.planner', 'taskVisitRelation.visit.lead')->first(); // This will throw a ModelNotFoundException if not found
    ...
    public function addTask(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'is_waiting' => 'nullable|boolean', // Ensure is_remind is a boolean
            'due_date' => 'nullable|date', // Ensure due_date is a valid date
            'start_date' => 'nullable|date', // Ensure due_date is a valid date
