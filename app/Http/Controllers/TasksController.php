...
$department = Department::find($id);
    ...
    public function showTaskDetails($taskId)
    {
        try {
            // Find the task by ID
            $task = Tasks::where('id',$taskId)->with('taskType', 'project', 'priority', 'creator', 'status', 'assignedPersons', 'taskVisitRelation')->first(); // This will throw a ModelNotFoundException if not found
