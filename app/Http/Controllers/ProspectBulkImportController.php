...
class ProspectBulkImportController extends Controller
{
    ...
    private function normalizeAndValidateRow(array $rawData, array &$seenContacts): array
    {
        ...
        $prospectData = [
            ...
            'is_individual' => $this->booleanValue($rawData['is_individual'] ?? false),
            ...
            'zone_id' => $this->nullableId($rawData['zone_id'] ?? null, 'zones', $errors),
            'division_id' => $this->nullableId($rawData['division_id'] ?? null, 'divisions', $errors),
            'district_id' => $this->nullableId($rawData['district_id'] ?? null, 'districts', $errors),
            'thana_id' => $this->nullableId($rawData['thana_id'] ?? null, 'upazilas', $errors),
            'type' => $this->clean($rawData['type'] ?? null) ?: 'prospect',
        ...
        return [
            ...
            'normalized_data' => [
                ...
                'contact' => $contactData,
                'is_client' => $this->booleanValue($rawData['is_client'] ?? false),
            ],
            'errors' => $errors,
            'warnings' => $warnings,
        ];
    ...
    private function normalizeContact(array $rawData, array &$errors, array &$warnings, array &$seenContacts): ?array
    {
        ...
        return [
            ...
            'is_primary' => $this->booleanValue($rawData['is_primary'] ?? false),
            'is_responsive' => $this->booleanValue($rawData['is_responsive'] ?? true),
            ...
            'is_key_contact' => $this->booleanValue($rawData['is_key_contact'] ?? false),
        ];
    }
